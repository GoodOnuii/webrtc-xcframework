Pod::Spec.new do |spec|
  ...
  spec.homepage = "https://github.com/GoodOnuii/webrtc-xcframework"
  ...
  spec.source = {
    :http => "https://github.com/GoodOnuii/webrtc-xcframework/releases/download/125.6422.04/LiveKitWebRTC.xcframework.zip"
  }
